    ...
    <SiteShell>
      <main className="py-16 sm:py-24">
        <Container className="max-w-3xl">
          <h1 className="font-display text-3xl font-[800] tracking-[-0.03em] leading-[1.08] text-brand-navy">Política de Privacidade</h1>
          ...
          <section className="mt-10 space-y-4 text-brand-gray">
            <h2 className="font-display text-xl font-bold tracking-[-0.03em] leading-[1.1] text-brand-navy">1. Dados coletados</h2>
            <p>
            ...
            <h2 className="font-display text-xl font-bold tracking-[-0.03em] leading-[1.1] text-brand-navy">2. Finalidade do tratamento</h2>
            <p>
            ...
            <h2 className="font-display text-xl font-bold tracking-[-0.03em] leading-[1.1] text-brand-navy">3. Compartilhamento</h2>
            <p>
            ...
            <h2 className="font-display text-xl font-bold tracking-[-0.03em] leading-[1.1] text-brand-navy">4. Seus direitos</h2>
            <p>
